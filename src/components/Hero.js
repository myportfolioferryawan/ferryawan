        ...
        <div className="flex items-center h-full pt-8">
          ...
          <div className="flex-1 flex flex-col items-center lg:items-start">
            ...
            <button className="btn btn-md bg-accent hover:bg-accent-hover md:btn-lg transition-all rounded-md ">
              {" "}
              <a
                href="https://drive.google.com/file/d/1vxumQNoC_EVBM1sp1HxdvNhe42-9ioV6/view?usp=sharing"
                download="https://drive.google.com/file/d/1vxumQNoC_EVBM1sp1HxdvNhe42-9ioV6/view?usp=sharing"
                target="_blank"
              >
                My Curriculum vitae
              </a>
